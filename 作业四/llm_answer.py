...
def tugraph_answer(query, db = 'default'):
    ...
    SCHEMA_TEXT = """
节点类型：
Executive:  高管节点，具有id、name、gender、age属性  Stock: 股票节点，具有id、name、code属性  Concept: 概念节点，具有id、name属性  Industry: 行业节点，具有id、name属性   关系类型：  (Executive)-[:EMPLOY_OF]->(Stock): 高管在公司的任职关系，具有jobs属性  (Stock)-[:CONCEPT_OF]->(Concept): 股票所属的概念板块  (Stock)-[:INDUSTRY_OF]->(Industry): 股票所属的行业分类
"""
...
# neo4j_answer("介绍一下王建业这个人")
# neo4j_answer("介绍一下王建业执掌的公司")
# neo4j_answer("赛轮金宇这个公司是哪个行业的，属于什么概念股？")
