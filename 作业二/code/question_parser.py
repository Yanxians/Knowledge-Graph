class QuestionPaser:
    ...
    def sql_transfer(self, question_type, entities):
        ...
        # 查询疾病的治愈概率
            ...
            sql = ["MATCH (m:Disease) where m.name = '{0}' return m.name, m.rate".format(i) for i in entities]
        ...
        # 查询疾病的易发人群
            ...
            sql = ["MATCH (m:Disease) where m.name = '{0}' return m.name, m.age".format(i) for i in entities]
        ...
        # 查询疾病应该进行的检查
            ...
            sql = ["MATCH (m:Disease) where m.name = '{0}' return m.name, m.checklist".format(i) for i in entities]
